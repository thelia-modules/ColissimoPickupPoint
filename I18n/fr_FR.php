...
return array(
    ...
    'All points (post offices, Pickup relay points, lockers, neighbors...)' => 'Tous les points (bureaux de Poste, relais Pickup, consignes, voisins-relais...)',
    'All points without Pickme neighbors relay' => 'Tous les points sans les voisins-relais Pickme',
    'All points without Pickup lockers' => 'Tous les points sans les consignes Pickup',
    ...
    'Colissimo Pickup Point update config' => 'Mise à jour de la configuration de ColissimoPickupPoint',
    'Colissimo URL prod' => 'URL de Colissimo en production',
    'ColissimoPickupPoint configuration' => 'Configuration de ColissimoPickupPoint',
    ...
    'No pickup points were selected' => 'Aucun point relais n\'a été sélectionné',
    'Operation successful. %i orders affected.' => 'Opération effectuée avec succès. %i commandes affectées.',
    'Password' => 'Mot de passe',
    'Pickup point type' => 'Type de points de retrait',
    'Pickup points only' => 'Points Pickup uniquement',
    'Pickup relay merchants only' => 'Relais commerçants Pickup uniquement',
    'Post offices and Pickup relay merchants' => 'Bureaux de Poste et relais commerçants Pickup',
    'Post offices only' => 'Bureaux de Poste uniquement',
